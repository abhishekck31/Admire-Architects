...
const RAW_DESIGN_PMC = [
  ...
  "CORPORATE OFFICE FOR M/S CDC, Bangalore (60,000 SFT)",
  ...
  "CGI Information Systems, Electronic City, Bangalore (1,00,000 SFT)",
  "DELL, Domlur (1,10,000 SFT)",
  "Dell, LAB (6000 SFT)",
  "Dell – CV Raman Nagar (55,000 SFT)",
  "IBM India Research Laboratory (4500 SFT)",
  "IBM Client Briefing Centre, EGL Bangalore (7500 SFT)",
...
const RAW_LATEST = [
  ...
  "Blue Print Technologies, Manyata Tech Park, Bangalore",
  ...
  "Parent Pay, Manyata Tech Park, Bangalore",
  "Zitra India, Whitefield, Bangalore",
  ...
  "GTP Common Area, Perungudi, Chennai",
  "Health Minds @ Yeshwanthpur, Bangalore",
  "GTP 13th Floor Chennai",
  "Celonis @ Table Space Tower, Bangalore",
  "PWC, Elnath Building, TP Bangalore",
